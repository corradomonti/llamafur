 ...
 * {@linkplain #WikipediaDocumentSequence(String, boolean, String, boolean, boolean, int, int, int) a quite humongous constructor}.
 * 
 ...
 * use a different {@linkplain #WikipediaDocumentSequence(String, boolean, String, boolean, boolean) constructor}.)
 * 
 * 
...
public class WikipediaDocumentSequence extends AbstractDocumentSequence implements Serializable {
	 ...
	 */
	public WikipediaDocumentSequence( final String file, final boolean bzipped, final String baseURL, final boolean parseText, final boolean keepNamespaced) {
	 ...
	 */
	public WikipediaDocumentSequence( final String file, final boolean bzipped, final String baseURL, final boolean parseText, final boolean keepNamespaced, final int maxPreAnchor, final int maxAnchor, final int maxPostAnchor) {
	...
	/** A string-based constructor to be used with an {@link ObjectParser}.
	 *
	 * @see #WikipediaDocumentSequence(String, boolean, String, boolean, boolean)
	 */
	public WikipediaDocumentSequence( final String file, final String bzipped, final String baseURL, final String parseText, final String keepNamespaced ) {
		this( file, Boolean.parseBoolean( bzipped ), baseURL, Boolean.parseBoolean( parseText ), Boolean.parseBoolean( keepNamespaced ) );
	}

	/** A string-based constructor to be used with an {@link ObjectParser}.
	 *
	 * @see #WikipediaDocumentSequence(String, boolean, String, boolean, boolean, int, int, int)
	 */
	public WikipediaDocumentSequence( final String file, final String bzipped, final String baseURL, final String parseText, final String keepNamespaced, final String maxBeforeAnchor, final String maxAnchor, final String maxPostAnchor ) {
